...
class timeletterReceive {
  ...
  async get() {
    ...
    console.log(date)
    let sql = `select * from timeletter,backimg where timeletter.lettertime<timestamp '${date}' and timeletter.backimgid = backimg.backimgid order by timeletter.letterid`;
