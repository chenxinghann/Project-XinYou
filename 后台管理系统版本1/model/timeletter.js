...
class timeletter{
  ...
  async insert(d) {
    ...
    this.mdb.connect().then(client=>{
      client.query('insert into timeletter values($1::int,$2::varchar,$3::int,$4::int,$5::text,$6::int,$7::int,$8::varchar,$9::int)',[letterid,data.lettertime,data.lettertid,data.themeid,data.content,data.backimgid,data.uid,data.lettertcolor,data.lettertstyleid]).then(res=>{
